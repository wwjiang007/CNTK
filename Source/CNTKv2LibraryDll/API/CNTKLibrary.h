...
\
    ...
    ///
    /// Create an instance of the squeeze operation on specified tensor input operand along given axes
    ///
    CNTK_API FunctionPtr Squeeze(const Variable& operand, const std::vector<Axis>& axes, const std::wstring& name = L"");
    ...
    ///
    CNTK_API FunctionPtr ReduceL1(const Variable& operand, const std::vector<Axis>& axis, const std::wstring& name = L"");
    ...
    ///
    CNTK_API FunctionPtr ReduceL2(const Variable& operand, const std::vector<Axis>& axis, const std::wstring& name = L"");
    ...
    ///
    CNTK_API FunctionPtr ReduceSumSquare(const Variable& operand, const std::vector<Axis>& axis, const std::wstring& name = L"");
